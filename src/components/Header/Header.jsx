...
export default function Header(){
    ...
    return(
        <header className={css.header}>
            ...
            <p onClick={() => {document.getElementById('gallery').scrollIntoView()}} className={css.mainHeaderText}>Галерея</p>
            <Link to={"/распродажа-сальников-со-склада/"} className={css.link}><p className={location.pathname=="/распродажа-сальников-со-склада/"? css.logoMain: css.mainHeaderText}>Распродажа сальников</p></Link>
            <Link to={"/about_us/"} className={css.link}> <p className={location.pathname=="/about_us/"? css.logoMain: css.mainHeaderText}>О нас</p></Link>
            <p onClick={() => {document.getElementById('gallery').scrollIntoView()}}  className={css.mainHeaderText}>Контакты</p>
